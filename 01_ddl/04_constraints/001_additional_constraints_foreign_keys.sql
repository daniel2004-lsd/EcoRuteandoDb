...
ALTER TABLE mobility.route_poi
    ADD CONSTRAINT fk_route_poi_route
        ...
        REFERENCES mobility.routes(route_id)
        ON DELETE CASCADE,
    ADD CONSTRAINT fk_route_poi_poi
        FOREIGN KEY (poi_id)
        REFERENCES mobility.points_of_interest(poi_id)
        ON DELETE CASCADE;
...
ALTER TABLE mobility.rating_votes
    ...
    ADD CONSTRAINT fk_rating_votes_rating
        ...
        REFERENCES mobility.ratings(rating_id)
        ON DELETE CASCADE;
...
ALTER TABLE community.report_votes
    ...
    ADD CONSTRAINT fk_report_votes_report
        ...
        REFERENCES community.obstacle_reports(report_id)
        ON DELETE CASCADE;
...
ALTER TABLE community.alerts
    ADD CONSTRAINT fk_alerts_weather
        FOREIGN KEY (weather_data_ref)
        REFERENCES integrations.weather_data(weather_id)
        ON DELETE SET NULL;

ALTER TABLE community.alert_route
    ADD CONSTRAINT fk_alert_route_alert
        FOREIGN KEY (alert_id)
        REFERENCES community.alerts(alert_id)
        ON DELETE CASCADE,
...
ALTER TABLE notifications.notifications
    ...
    ADD CONSTRAINT fk_notifications_template
        ...
        REFERENCES notifications.notification_templates(template_id)
        ON DELETE SET NULL;
...
ALTER TABLE admin.support_messages
    ADD CONSTRAINT fk_support_messages_ticket
        ...
        REFERENCES admin.support_tickets(ticket_id)
        ON DELETE CASCADE,
